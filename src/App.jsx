          ...
          <Route path="/support" element={
            <>
              <div className="page-hero">
                ...
                <div className="page-title">SUPPORT THE <span style={{ color: "var(--gold, #ffcc00)" }}>PROJECT</span></div>
                <div className="page-sub">Help keep these resources free and accessible for the entire community</div>
              </div>
                ...
                <div data-support-grid="" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, alignItems: "start" }}>
                  ...
                  <div style={{ fontFamily: "'Share Tech Mono',monospace" }}>
                    ...
                    <div style={{ fontSize: "0.68rem", color: "#9ab0cc", lineHeight: 2, marginBottom: 24, letterSpacing: "0.3px" }}>
                      ...
                      That's basically the equivalent of a gold-plated inner frame.
                    </div>
